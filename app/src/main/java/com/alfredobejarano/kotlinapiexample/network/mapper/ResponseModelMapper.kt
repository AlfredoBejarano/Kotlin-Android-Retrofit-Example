package com.alfredobejarano.kotlinapiexample.network.mapper

import com.alfredobejarano.kotlinapiexample.network.APIInterface
 ...
 */
class ResponseModelMapper() : Callback<ResponseModel> {
    ...
    fun buildApiCall() {
        ...
        val getData: APIInterface = httpRestClient.create(APIInterface::class.java)
